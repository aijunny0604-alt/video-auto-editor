...
| M | 산출물 | 기한 (목표) |
|---|--------|-------------|
| M0 | 프로젝트 초기화 + GitHub 푸시 | **2026-05-27 (오늘)** |
| M1 | PDCA Design 완료 | +3일 |
| M2 | CapCut draft 스키마 분석 완료 | +5일 |
| M3 | 무음 제거 PoC (Codex 위임) | +7일 |
| M4 | Whisper STT 통합 | +10일 |
| M5 | 브이로그 모드 E2E 동작 | +14일 |
| M6 | 숏폼 모드 E2E 동작 | +21일 |
| M7 | gap-detector 검증 ≥ 90% | +25일 |
